    ...
    <div class="db-shell bg-background text-foreground min-h-screen">
        ...
        <main class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-4 sm:grid-cols-4 text-center">
                ...
                <div class="rounded-2xl border border-border bg-card text-card-foreground p-6 shadow-sm">
                    <p class="text-3xl font-black text-sky-600 dark:text-sky-400">$1M+</p>
                    <p class="mt-1 text-xs text-muted-foreground">Cloud Cost Savings Delivered</p>
                </div>
                <div class="rounded-2xl border border-border bg-card text-card-foreground p-6 shadow-sm">
                    <p class="text-3xl font-black text-purple-600 dark:text-purple-400">&lt;0.5s</p>
                    <p class="mt-1 text-xs text-muted-foreground">Initial Page Load Benchmark</p>
                </div>
                <div class="rounded-2xl border border-border bg-card text-card-foreground p-6 shadow-sm">
                    <p class="text-3xl font-black text-amber-600 dark:text-amber-400">VILT</p>
                    <p class="mt-1 text-xs text-muted-foreground">Vue 3, Inertia, Laravel, Tailwind</p>
                </div>
            </div>
            ...
            <div class="mt-12 space-y-8">
                <div class="rounded-3xl border border-border bg-card text-card-foreground p-8 shadow-sm">
                    <h3 class="text-xl font-bold text-card-foreground">The Engineering Challenge</h3>
                ...
                <div class="rounded-3xl border border-border bg-card text-card-foreground p-8 shadow-sm">
                    ...
                    <div class="mt-6 flex flex-wrap gap-2">
                        <span class="rounded-full bg-secondary px-3 py-1 text-xs font-bold text-secondary-foreground border border-border">Laravel 12/13</span>
                        ...
                        <span class="rounded-full bg-secondary px-3 py-1 text-xs font-bold text-secondary-foreground border border-border">Filament CMS</span>
                ...
                <div class="rounded-3xl border border-border bg-secondary/60 p-8 shadow-md">
                    ...
                    <p class="mt-4 text-xs font-bold text-card-foreground">— Ashish Gupta, Lead Architect & Founder, DigitalBuilders</p>
                </div>
            </div>

            <div class="mt-16 text-center">
                <h3 class="text-2xl font-black text-foreground">Need an Enterprise Software Architect?</h3>
                <div class="mt-6 flex flex-wrap justify-center gap-4">
                    <a href="https://ashishgupta.dev/" target="_blank" rel="noopener noreferrer" class="rounded-full border border-border bg-secondary px-6 py-3.5 text-sm font-bold text-secondary-foreground hover:bg-secondary/80 inline-flex items-center gap-2">
